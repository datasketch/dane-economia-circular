            ...
            <div className='max-w-[567.62px] mx-auto text-center'>
              <div className='space-y-5'>
                ...
                <div className='flex flex-col gap-y-4 lg:flex-row items-center justify-between'>
                  ...
                  <a href='/archives/Metadato_SDMX_SIEC_Consolidado.zip' className='inline-flex items-center gap-x-[21.83px] py-[11.5px] pl-[43.99px] pr-[37.99px] bg-pink text-white font-bold text-[14px] overflow-hidden rounded-tr-[20px] rounded-bl-[20px] hover:bg-pink-2 duration-300 group' download>
                    <span>
                      Ficha metodológica
                    </span>
                    <img className='group-hover:scale-150 duration-300' src='/images/link-arrow-icon.svg' alt='link arrow icon' />
