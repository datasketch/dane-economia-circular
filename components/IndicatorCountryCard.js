export const IndicatorCountryCard = ({ item }) => {
  ...
  return (
        <div className={`bg-cover bg-center max-w-[463.7px] h-[401.07px] w-full rounded-tr-[50px] overflow-hidden relative mx-auto ${classNames}`} style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url("${bgImage}"` }}>
